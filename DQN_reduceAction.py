...
if __name__ == '__main__':
    ...
    model_path = './reducedModel/'
    data_path = './reducedData/'
    solutionPicture_path='./reducedSolutionPicture/'
    solutionResult_path='./reducedSolutionResult/'
