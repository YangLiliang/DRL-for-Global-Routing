...
class DQN_Agent():
    ...
    def train(self, savepath, model_file=None):
        ...
        # 保存参数
        # saver = tf.train.Saver()
        # saver.save(sess, model_path + 'my_net.ckpt')
...
if __name__ == '__main__':
    ...
    model_file = model_path + filename + '.ckpt'
    ...
    ## 输出测试结果
    overFlow,totalLength=test.testDRLSolution(routeListNotMerged,gridParameters,solutionPicture_path,filename)
